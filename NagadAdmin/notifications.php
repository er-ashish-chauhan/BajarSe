...
<?php
  ...
  $sql="SELECT id,title,message,success,failure,created_at FROM notifications";
  $exe = $db->query($sql);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <button type="button" class="btn theme-btn pull-right " data-toggle="modal" data-target="#send_notification" style="margin-right: 10px;">Send Notification<i class="fa fa-plus-circle"></i></button>
...
foreach ($data as $key => $item){
        ...
        echo'<td>'.$item['success'].'</td>';
        echo'<td>'.$item['failure'].'</td>';
