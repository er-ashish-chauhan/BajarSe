...
<?php
  ...
  $sql="SELECT users.business_name,users.email,users.mobile AS vendor_mobile,user_bank_detail.id,user_bank_detail.account_name,user_bank_detail.account_number,user_bank_detail.ifsc_code,user_bank_detail.account_type,user_bank_detail.gst,user_bank_detail.pan FROM user_bank_detail INNER JOIN users ON(users.id=user_bank_detail.user_id)";
  $exe = $db->query($sql);
...
foreach ($data as $key => $item){
        ...
        echo'<td>'.$item['account_number'].'</td>';
        echo'<td>'.$item['ifsc_code'].'</td>';
