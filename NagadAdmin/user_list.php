<?php
  ...
  if(isset($_POST['create_csv'])){
    ...
    foreach ($data as $key => $item){
        ...
        $new = [$count,$item['name'],$item['business_name'],$item['category'],$item['address'],$item['mobile'],$item['email'],$status,$item['created_at']];
    ...
    fputcsv($file, array('#','Name', 'Business Name', 'Category','Address','Mobile no','Email', 'Status','Create Time'));
